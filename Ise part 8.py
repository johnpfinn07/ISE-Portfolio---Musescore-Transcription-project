...
# Violin 1
m4_v1.append(note.Note("F#5", quarterLength=0.5))
m4_v1.append(note.Note("G5", quarterLength=0.5))
m4_v1.append(note.Note("A5", quarterLength=0.5))
m4_v1.append(note.Note("D5", quarterLength=0.5))
m4_v1.append(note.Note("F#5", quarterLength=0.5))
...
m4_v2.append(note.Note("A4", quarterLength=1))
m4_v2.append(note.Note("F#3", quarterLength=0.5))

# Violin 3
m4_v3.append(note.Note("D4", quarterLength=1.5))
m4_v3.append(note.Note("D3", quarterLength=1.5))
m4_v3.append(note.Note("D3", quarterLength=1.5))

# Cello
m4_c.append(note.Note("D2", quarterLength=1.5))
m4_c.append(note.Note("F2", quarterLength=1.5))
...
# Violin 1
m5_v1.append(note.Note("B5", quarterLength=0.5))
m5_v1.append(note.Note("G5", quarterLength=0.5))
m5_v1.append(note.Note("A5", quarterLength=0.5))
m5_v1.append(note.Note("B5", quarterLength=0.5))
m5_v1.append(note.Note("D5", quarterLength=0.5))
m5_v1.append(note.Note("C4", quarterLength=0.5))
m5_v1.append(note.Note("C4", quarterLength=0.5))
m5_v1.append(note.Note("E4", quarterLength=0.5))
m5_v1.append(note.Note("D4", quarterLength=0.5))
...
m5_v2.append(note.Note("F#4", quarterLength=0.5))
m5_v2.append(note.Note("G4", quarterLength=1))
m5_v2.append(note.Note("A3", quarterLength=0.5))

# Violin 3
m5_v3.append(note.Note("G4", quarterLength=1.5))
m5_v3.append(note.Note("E3", quarterLength=1.5))
m5_v3.append(note.Note("E3", quarterLength=1.5))

# Cello
m5_c.append(note.Note("G2", quarterLength=1.5))
m5_c.append(note.Note("E2", quarterLength=1.5))
...
m6_v1.append(note.Note("F5", quarterLength=0.5))
m6_v1.append(note.Note("G5", quarterLength=0.5))
m6_v1.append(note.Note("D5", quarterLength=0.5))
...
m6_v2.append(note.Note("G3", quarterLength=0.5))

# Violin 3
m6_v3.append(note.Note("G4", quarterLength=1))
m6_v3.append(note.Note("F#3", quarterLength=0.5))
m6_v3.append(note.Note("E3", quarterLength=1.5))
m6_v3.append(note.Note("D3", quarterLength=1.5))

# Cello
m6_c.append(note.Note("B2", quarterLength=1.5))
m6_c.append(note.Note("E2", quarterLength=1.5))
...
# Violin 1
m7_v1.append(note.Note("E5", quarterLength=0.5))
m7_v1.append(note.Note("D5", quarterLength=0.5))
m7_v1.append(note.Note("C5", quarterLength=0.5))
m7_v1.append(note.Note("B5", quarterLength=0.5))
m7_v1.append(note.Note("A5", quarterLength=0.5))
m7_v1.append(note.Note("G4", quarterLength=0.5))
m7_v1.append(note.Note("D4", quarterLength=0.5))
m7_v1.append(note.Note("G4", quarterLength=0.5))
m7_v1.append(note.Note("F4", quarterLength=0.5))
...
m7_v2.append(note.Note("A4", quarterLength=1))
m7_v2.append(note.Note("C3", quarterLength=0.5))

# Violin 3
m7_v3.append(note.Note("D4", quarterLength=1.5))
m7_v3.append(note.Note("E3", quarterLength=1.5))
m7_v3.append(note.Note("D3", quarterLength=1.5))

# Cello
m7_c.append(note.Note("C2", quarterLength=1.5))
m7_c.append(note.Note("C#2", quarterLength=1.5))
...
m8_v1.append(note.Note("B5", quarterLength=0.5))
...
m8_v1.append(note.Note("B4", quarterLength=0.5))
m8_v1.append(note.Note("D4", quarterLength=0.5))

# Violin 2
m8_v2.append(note.Note("B4", quarterLength=1))
m8_v2.append(note.Note("G4", quarterLength=0.5))
m8_v2.append(note.Note("B4", quarterLength=1))
m8_v2.append(note.Note("D4", quarterLength=0.5))
m8_v2.append(note.Note("G4", quarterLength=1.5))

# Violin 3
m8_v3.append(note.Note("G4", quarterLength=1.5))
...
m8_c.append(note.Note("B3", quarterLength=0.5))
...
# Violin 1
m9_v1.append(note.Note("C5", quarterLength=2))
...
m9_v3.append(note.Note("E3", quarterLength=1.5))

# Cello
m9_c.append(note.Note("G2", quarterLength=1.5))
m9_c.append(note.Note("F2", quarterLength=1.5))
...
# Violin 3
m10_v3.append(note.Note("A4", quarterLength=3))
m10_v3.append(note.Note("B3", quarterLength=1.5))


# Cello
m10_c.append(note.Note("F#2", quarterLength=1.5))
m10_c.append(note.Note("E2", quarterLength=1.5))
...
m11_v1.append(note.Note("B5", quarterLength=1.5))
...
# Violin 3
m11_v3.append(note.Note("B4", quarterLength=1.5))
m11_v3.append(note.Note("A3", quarterLength=1.5))
m11_v3.append(note.Note("G3", quarterLength=1.5))

# Cello
m11_c.append(note.Note("E2", quarterLength=1.5))
m11_c.append(note.Note("F2", quarterLength=1.5))
...
m12_v1.append(note.Note("D5", quarterLength=0.5))
m12_v1.append(note.Note("E5", quarterLength=0.5))
m12_v1.append(note.Note("F#5", quarterLength=0.5))
m12_v1.append(note.Note("A5", quarterLength=0.5))
m12_v1.append(note.Note("G4", quarterLength=0.5))
m12_v1.append(note.Note("A4", quarterLength=0.5))
m12_v1.append(note.Note("C4", quarterLength=0.5))
...
# Violin 3
m12_v3.append(note.Note("A4", quarterLength=1.5))
...
# Cello
m12_c.append(note.Note("D2", quarterLength=1.5))
...
m13_v1.append(note.Note("A5", quarterLength=0.5))
m13_v1.append(note.Note("F#5", quarterLength=0.5))
m13_v1.append(note.Note("D5", quarterLength=0.5))
m13_v1.append(note.Note("F#5", quarterLength=0.5))
m13_v1.append(note.Note("A4", quarterLength=0.5))
m13_v1.append(note.Note("C4", quarterLength=0.5))
m13_v1.append(note.Note("B4", quarterLength=0.5))
m13_v1.append(note.Note("A4", quarterLength=0.5))

# Violin 2
m13_v2.append(note.Note("A4", quarterLength=1))
m13_v2.append(note.Note("C4", quarterLength=0.5))
m13_v2.append(note.Note("A4", quarterLength=1))
m13_v2.append(note.Note("F#4", quarterLength=0.5))
m13_v2.append(note.Note("D4", quarterLength=1))
m13_v2.append(note.Note("F#3", quarterLength=0.5))
...
m13_c.append(note.Rest(quarterLength=1.5))
...
# Violin 1
m14_v1.append(note.Note("B5", quarterLength=0.5))
m14_v1.append(note.Note("G5", quarterLength=0.5))
m14_v1.append(note.Note("A5", quarterLength=0.5))
m14_v1.append(note.Note("B5", quarterLength=0.5))
m14_v1.append(note.Note("D5", quarterLength=0.5))
m14_v1.append(note.Note("C4", quarterLength=0.5))
m14_v1.append(note.Note("C4", quarterLength=0.5))
m14_v1.append(note.Note("E4", quarterLength=0.5))
m14_v1.append(note.Note("D4", quarterLength=0.5))

# Violin 2
m14_v2.append(note.Note("B4", quarterLength=3))
m14_v2.append(note.Note("C4", quarterLength=1.5))

# Violin 3
m14_v3.append(note.Note("G4", quarterLength=3))
m14_v3.append(note.Note("G3", quarterLength=1.5))

# Cello
m14_c.append(note.Note("G2", quarterLength=1.5))
m14_c.append(note.Note("F2", quarterLength=1.5))
...
m15_v1.append(note.Note("F5", quarterLength=0.5))
m15_v1.append(note.Note("G5", quarterLength=0.5))
m15_v1.append(note.Note("D5", quarterLength=0.5))
...
# Violin 2
m15_v2.append(note.Note("D4", quarterLength=1.5))
...
m15_v3.append(note.Note("D3", quarterLength=1.5))
m15_v3.append(note.Note("G3", quarterLength=1.5))
...
# Violin 1
m16_v1.append(note.Note("E5", quarterLength=0.5))
m16_v1.append(note.Note("D5", quarterLength=0.5))
m16_v1.append(note.Note("C5", quarterLength=0.5))
m16_v1.append(note.Note("B5", quarterLength=0.5))
m16_v1.append(note.Note("A5", quarterLength=0.5))
...
m16_v2.append(note.Note("C4", quarterLength=0.25))
...
m16_v3.append(note.Note("E3", quarterLength=0.5))
m16_v3.append(note.Note("F#3", quarterLength=0.5))
m16_v3.append(note.Note("E3", quarterLength=0.5))
m16_v3.append(note.Note("F#3", quarterLength=1.5))

# Cello
m16_c.append(note.Note("C2", quarterLength=1.5))
...
# Violin 1
m17_v1.append(note.Note("G5", quarterLength=3))
...
# Cello
m17_c.append(note.Note("G4", quarterLength=3))
